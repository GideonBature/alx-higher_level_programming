...
"""This Module defines a MagicClass that reps a circle with radius"""
...
class MagicClass:
    """
    A class representing a circle and providing methods to calculate its area and circumference.

    Attributes:
        _MagicClass__radius (int or float): The radius of the circle.

    Methods:
        __init__(self, _MagicClass__radius=0): Constructor to initialize the circle with a radius.
